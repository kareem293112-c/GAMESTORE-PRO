  ...
  return (
    <>
      <motion.div
        ...
        viewport={{ once: true }}
        className="group relative flex flex-col bg-slate-800 rounded-xl hover:shadow-2xl hover:shadow-indigo-500/20 transition-all duration-300 overflow-hidden border border-slate-700/50 hover:-translate-y-1.5"
        dir="rtl"
      >
        {product.discount > 0 && (
