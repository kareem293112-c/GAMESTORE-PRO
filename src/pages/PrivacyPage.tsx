        ...
        <div className="space-y-8 text-sm leading-relaxed">
          ...
          <section className="bg-slate-900/60 rounded-2xl p-6 border border-slate-800">
            ...
            <p className="text-slate-400">
              Kişisel verileriniz; ödeme işlemcileri, yasal zorunluluklar veya açık rızanız olmadan üçüncü taraflarla paylaşılmaz. 
              Ödeme altyapısı PCI-DSS uyumlu güvenli sistemler üzerinden çalışmaktadır.
            </p>
          </section>
          ...
          <section className="bg-slate-900/60 rounded-2xl p-6 border border-slate-800 border-l-2 border-l-amber-500">
            ...
            <p className="text-slate-400">
              ...
              Ürün teslimattan sonra iade veya iptal mümkün <span className="text-amber-400 font-semibold">değildir</span>. 
          ...
          <section className="bg-slate-900/60 rounded-2xl p-6 border border-slate-800">
            ...
            <p className="text-slate-400">
              Sitemiz oturum yönetimi ve kullanıcı deneyimini iyileştirmek amacıyla çerezler kullanmaktadır. 
              Tarayıcı ayarlarınızdan çerezleri devre dışı bırakabilirsiniz, ancak bu bazı işlevleri etkileyebilir.
            </p>
          </section>
