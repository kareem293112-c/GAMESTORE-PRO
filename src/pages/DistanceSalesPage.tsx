      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6 text-sm leading-relaxed">
          ...
          <section className="bg-slate-900/60 rounded-2xl p-6 border border-slate-800">
            ...
            <p className="text-slate-400">
              Satışa sunulan ürünlerin özellikleri, fiyatları ve açıklamaları site üzerinde ilgili ürün sayfasında 
              yer almaktadır. Tüm fiyatlara KDV dahildir. Satıcı, fiyatları önceden bildirmeksizin 
              güncelleme hakkını saklı tutar; ancak sipariş anındaki fiyat geçerlidir.
            </p>
          </section>
          ...
          <section className="bg-slate-900/60 rounded-2xl p-6 border border-slate-800">
            ...
            <p className="text-slate-400">
              Dijital ürünler, ödemenin onaylanmasının ardından <span className="text-white font-semibold">anında ve otomatik olarak</span> Alıcı'nın 
          ...
          <section className="bg-slate-900/60 rounded-2xl p-6 border border-slate-800 border-l-2 border-l-red-500">
            ...
            <div className="bg-red-950/30 rounded-xl p-4 border border-red-900/50 mb-3">
              ...
              <p className="text-slate-300">
                Mesafeli Sözleşmeler Yönetmeliği'nin 15. maddesi uyarınca, elektronik ortamda anında teslim edilen 
                dijital içerikler (oyun kodu, aktivasyon anahtarı, gift card vb.) teslim edildikten sonra 
          ...
          <section className="bg-slate-900/60 rounded-2xl p-6 border border-slate-800">
            ...
            <p className="text-slate-400">
              Bu sözleşmeden doğan uyuşmazlıklarda Türkiye Cumhuriyeti mahkemeleri ve Tüketici Hakem Heyetleri 
              yetkilidir. Tüketici şikayetleri için{' '}
              <a href="https://www.tuketicisikayetleri.gov.tr" target="_blank" rel="noopener noreferrer" 
                className="text-indigo-400 hover:underline">tüketici şikayetleri portalı</a>{' '}
              kullanılabilir.
            </p>
          </section>
