...
const translations = {
  ar: {
    ...
    'features.instantDesc': 'استلم كودك مباشرة',
    'features.bestPrice': 'أفضل الأسعار',
    'features.bestPriceDesc': 'خصومات حصرية يومية',
    'features.secure': 'متجر آمن',
    'features.secureDesc': 'حماية بياناتك أولويتنا',
    'features.support': 'دعم 24/7',
    'features.supportDesc': 'نحن هنا لمساعدتك',
  ...
  en: {
    ...
    'features.instantDesc': 'Receive your code immediately',
    'features.bestPrice': 'Best Prices',
    'features.bestPriceDesc': 'Daily exclusive discounts',
    'features.secure': 'Secure Store',
    'features.secureDesc': 'Your data protection is our priority',
    'features.support': '24/7 Support',
    'features.supportDesc': 'We are here to help you',
